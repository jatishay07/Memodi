// Memodi — shared ambient background components (blobs + particles).
// Loaded by every Patient screen.

const PatientAmbient = ({ particleCount = 8 }) => {
...
window.PatientAmbient = PatientAmbient;
