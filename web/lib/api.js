...
export async function editMemoryItem(patientId, field, index, item, photoBase64 = null) {
  return request('/memory/edit', { method: 'POST', body: JSON.stringify({ patientId, field, index, item, photoBase64 }) });
}
